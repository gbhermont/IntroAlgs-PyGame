...
Largura_Carta = 100  # largura de cada carta na tela em pixels
Altura_Carta  = 100  # altura de cada carta na tela em pixels
Espaco        = 15   # distância entre uma carta e outra
